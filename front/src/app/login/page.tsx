        ...
        <div className="min-h-screen flex">
            <div className="w-64 bg-gray-50 border-r border-gray-100 p-6 flex flex-col">
                ...
                <div className="pt-6 border-t border-gray-200">
                    <Link href="/login" className="block py-2 px-3 bg-gray-200 text-gray-800 rounded-md font-medium mb-2 text-center">
                        Вход
                    </Link>
            ...
            <div className="flex-1 bg-white flex items-center justify-center p-8">
                <div className="w-full max-w-sm">
                    <div className="mb-8">
                        <h1 className="text-2xl font-medium text-gray-800 mb-1">Вход в аккаунт</h1>
                        <p className="text-gray-500 text-sm">Введите данные для входа</p>
                    </div>
